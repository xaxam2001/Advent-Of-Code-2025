use crate::d2::{d2p1_v1, d2p1_v2, d2p1_v3, d2p1_v4, d2p1_v5 /*d2p2_v1, d2p2_v2*/};
...
pub fn d2(c: &mut Criterion) {
    ...
    group.bench_function("d2p1_v4", |b| {
        b.iter(|| d2p1_v4(black_box(include_str!("d2/d2.txt"))))
    });

    group.bench_function("d2p1_v5", |b| {
        b.iter(|| d2p1_v5(black_box(include_str!("d2/d2.txt"))))
    });
